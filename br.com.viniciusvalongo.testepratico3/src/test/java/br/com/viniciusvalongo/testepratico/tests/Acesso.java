...
import br.com.viniciusvalongo.testepratico.pages.CartPage;
import br.com.viniciusvalongo.testepratico.pages.CheckoutPage;
import br.com.viniciusvalongo.testepratico.pages.HomePage;
import br.com.viniciusvalongo.testepratico.pages.ProductPage;
...
public class Acesso {
	...
	private final ProductPage pp  = new ProductPage(driver);
	private final CheckoutPage cc = new CheckoutPage(driver);
	private final CartPage cp = new CartPage(driver);
